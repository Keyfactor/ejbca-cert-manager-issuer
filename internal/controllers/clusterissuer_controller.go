...
//+kubebuilder:rbac:groups=ejbca-issuer.keyfactor.com,resources=clusterissuers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ejbca-issuer.keyfactor.com,resources=clusterissuers/finalizers,verbs=update
